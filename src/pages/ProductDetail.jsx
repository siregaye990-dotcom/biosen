        ...
        <div className={styles.orderSide}>
          <div className={styles.orderCard}>
            ...
            <div className={styles.badges}>
              <div className={styles.badge}>🌱 100% Bio certifié</div>
              <div className={styles.badge}>🇸🇳 Origine Sénégal</div>
              <div className={styles.badge}>⚡ Précuit, prêt vite</div>
              <div className={styles.badge}>🚚 Livraison disponible</div>
            </div>
          </div>
        </div>
      </div>
